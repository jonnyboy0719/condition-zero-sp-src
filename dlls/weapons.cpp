...
void W_Precache()
{
	...
	UTIL_PrecacheOtherWeapon("weapon_machete");
	...
	UTIL_PrecacheOther("ammo_radiobomb");

	// grenades
	UTIL_PrecacheOtherWeapon("weapon_flashbang");
	UTIL_PrecacheOtherWeapon("weapon_nervgasgrenade");
	...
	// used by turrets
	PRECACHE_MODEL("models/props/turret_50cal_bigb.mdl");
	...
	PRECACHE_SOUND("weapons/hits/bullet_hit1.wav");
	PRECACHE_SOUND("weapons/hits/bullet_hit2.wav");
	PRECACHE_SOUND("weapons/hits/headshot.wav");
}
...
TYPEDESCRIPTION CRpg::m_SaveData[] =
	{
		...
		DEFINE_FIELD(CRpg, m_bFiredRocket, FIELD_BOOLEAN),
