...
LINK_ENTITY_TO_CLASS(weapon_deagle, CPython);
...
void CPython::Precache()
{
	...
	PRECACHE_MODEL("models/w_50ae.mdl");
...
void CPython::Reload()
{
	...
	DefaultReload(7, PYTHON_RELOAD, 2.0, bUseScope ? 1 : 0);
}
...
LINK_ENTITY_TO_CLASS(ammo_50ae, CPythonAmmo);
