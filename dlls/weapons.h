...
public:
	...
	static CGrenade* ShootTimed(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, int type);
	...
	void OnType_Explode(TraceResult* pTrace, int bitsDamageType);
	void OnType_Flash(TraceResult* pTrace, int bitsDamageType);
	void OnType_Smoke(TraceResult* pTrace, int bitsDamageType);
...
public:
	...
	virtual handgrenade_type_e GrenadeType() { return handgrenade_type_e::GRENADE_TYPE_EXPLOSIVE; }
	bool GetItemInfo(ItemInfo* p) override;
...
class CNervGasGrenade : public CHandGrenade
{
public:
	void Spawn() override;
	void Precache() override;
	bool Deploy() override;
	bool GetItemInfo(ItemInfo* p) override;
	virtual handgrenade_type_e GrenadeType() { return handgrenade_type_e::GRENADE_TYPE_GAS; }
};
...
public:
	...
	bool Deploy() override;
	bool GetItemInfo(ItemInfo* p) override;
	virtual handgrenade_type_e GrenadeType() { return handgrenade_type_e::GRENADE_TYPE_FLASH; }
};

class CSmokeGrenade : public CHandGrenade
{
public:
	void Spawn() override;
	void Precache() override;
	bool Deploy() override;
	bool GetItemInfo(ItemInfo* p) override;
	virtual handgrenade_type_e GrenadeType() { return handgrenade_type_e::GRENADE_TYPE_SMOKE; }
};
...
enum radiocontroller_e
{
	RADIOCONTROLLER_IDLE_BOMB = 0,
	RADIOCONTROLLER_IDLE_CONTROLLER,
	RADIOCONTROLLER_DRAW_BOMB,
	RADIOCONTROLLER_DRAW_DETONATOR,
	RADIOCONTROLLER_HOLSTER_BOMB,
	RADIOCONTROLLER_HOLSTER_DETONATOR,
	RADIOCONTROLLER_PLANT,
	RADIOCONTROLLER_DETONATE
};

class CRadioBombController : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	void Precache() override;
