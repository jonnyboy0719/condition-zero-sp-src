...
bool CBreakable::KeyValue(KeyValueData* pkvd)
{
	...
	else if (FStrEq(pkvd->szKeyName, "radiobomb"))
	{
		m_radiobomb = atoi(pkvd->szValue) >= 1 ? true : false;
		return true;
	}
...
TYPEDESCRIPTION CBreakable::m_SaveData[] =
	{
		DEFINE_FIELD(CBreakable, m_radiobomb, FIELD_BOOLEAN),
