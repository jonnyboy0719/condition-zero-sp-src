...
typedef V_HSPRITE (*pfnEngSrc_pfnSPR_Load_t)(const char* szPicName);
typedef int (*pfnEngSrc_pfnSPR_Frames_t)(V_HSPRITE hPic);
typedef int (*pfnEngSrc_pfnSPR_Height_t)(V_HSPRITE hPic, int frame);
typedef int (*pfnEngSrc_pfnSPR_Width_t)(V_HSPRITE hPic, int frame);
typedef void (*pfnEngSrc_pfnSPR_Set_t)(V_HSPRITE hPic, int r, int g, int b);
...
typedef void (*pfnEngSrc_pfnSetCrosshair_t)(V_HSPRITE hspr, Rect rc, int r, int g, int b);
...
typedef const struct model_s* (*pfnEngSrc_GetSpritePointer_t)(V_HSPRITE V_HSPRITE);
