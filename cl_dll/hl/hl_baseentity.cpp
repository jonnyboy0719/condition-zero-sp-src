...
void CBaseEntity::CustomSoundPrecache(std::string szSound) {}
...
void CGrenade::Spawn() {}
CGrenade* CGrenade::ShootTimed(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity, float time, int type) { return 0; }
