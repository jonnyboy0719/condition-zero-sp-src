...
bool CHudHealth::Draw(float flTime)
{
	...
	if (0 == m_V_HSPRITE)
		m_V_HSPRITE = LoadSprite(PAIN_NAME);
...
bool CHudHealth::DrawPain(float flTime)
{
	...
	if (m_fAttackFront > 0.4)
	{
		...
		SPR_Set(m_V_HSPRITE, r, g, b);

		x = ScreenWidth / 2 - SPR_Width(m_V_HSPRITE, 0) / 2;
		y = ScreenHeight / 2 - SPR_Height(m_V_HSPRITE, 0) * 3;
	...
	if (m_fAttackRight > 0.4)
	{
		...
		x = ScreenWidth / 2 + SPR_Width(m_V_HSPRITE, 1) * 2;
		y = ScreenHeight / 2 - SPR_Height(m_V_HSPRITE, 1) / 2;
	...
	if (m_fAttackRear > 0.4)
	{
		...
		x = ScreenWidth / 2 - SPR_Width(m_V_HSPRITE, 2) / 2;
		y = ScreenHeight / 2 + SPR_Height(m_V_HSPRITE, 2) * 2;
	...
	if (m_fAttackLeft > 0.4)
	{
		...
		x = ScreenWidth / 2 - SPR_Width(m_V_HSPRITE, 3) * 3;
		y = ScreenHeight / 2 - SPR_Height(m_V_HSPRITE, 3) / 2;
